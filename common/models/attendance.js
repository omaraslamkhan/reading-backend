...
module.exports = function (Attendance) {
  ...
  Attendance.findStudents = function (classRoomId,startDate,endDate, cb) {
    ...
    if(startDate && endDate !=null){
        _where = { where: { classRoomId: classRoomId,date: {between:[new Date(startDate), new Date(endDate)]}}  }
       }
    else{
  ...
  Attendance.remoteMethod("findStudents", {
    accepts: [{ arg: "classRoomId", type: "string" },{ arg: "startDate", type: "string" },{ arg: "endDate", type: "string" }],
